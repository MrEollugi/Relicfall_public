...
public class SteamManager : MonoBehaviour {
	...
	protected static SteamManager Instance {
		get {
			if (s_instance == null) {
                Debug.LogError("[SteamManager] SteamManager instance not found in scene! Please add a SteamManager GameObject.");
            }
			return s_instance;
		}
	}
	...
	protected virtual void Awake() {
		...
		try {
			...
			else
			{
				if (!SteamAPI.Init())
				{
                    Debug.LogError("[SteamManager] SteamAPI_Init() failed. Please ensure Steam is running.");
					// TODO: 사용자에게 알림 UI 띄우기 or 로비 화면 전환
					return;
                }
			}
		}
